  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 z-50">
        ...
        <LoaderCircle className="absolute top-[calc(50%-0.75rem)] left-[calc(50%-0.75rem)] size-4 animate-spin text-blue-700" />
      </div>
    </div>
  );
};
  ...
  return (
    <>
      ...
      `}
        ...
        >
          <div className="spinner rounded-full bg-[conic-gradient(from_0deg_at_50%_50%,rgb(43,127,255)_0deg,rgba(42,138,246,0)_360deg)]" />
        </div>
      </div>
      {children}
    </>
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute -top-[1.5px] -left-[1.5px] h-[calc(100%+3px)] w-[calc(100%+3px)] rounded-[9px] border-2",
          className,
        )}
      />
      {children}
